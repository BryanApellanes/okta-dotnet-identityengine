...
namespace Okta.IdentityEngine.Session
{
    ...
    /// </summary>
    public sealed class SecureSessionProvider : IIdentitySessionProvider
    {
        ...
        public SecureSessionProvider(IStorageProvider storageProvider = null, IIdentityLoggingProvider loggingProvider = null)
        {
            this.LoggingProvider = loggingProvider ?? new IdentityLoggingProvider();
        ...
        public IIdentityLoggingProvider LoggingProvider { get; set; }
