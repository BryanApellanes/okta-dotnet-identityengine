...
namespace Okta.IdentityEngine.Client
{
    ...
    public class HttpMessageInterceptor : HttpClientHandler
    {
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                this.SendStarted?.Invoke(this, new HttpMessageEventArgs
                {
                    Handler = this,
                    Request = request,
                });
                response = await SendRequestAsync(request, cancellationToken);
                this.SendCompleted?.Invoke(this, new HttpMessageEventArgs
                {
                    Handler = this,
                    Request = request,
                    Response = response,
            ...
            {
                this.SendExceptionThrown?.Invoke(this, new HttpMessageEventArgs
                {
                    Request = request,
                    Exception = ex,
                });
