...
namespace Okta.IdentityEngine.Ion
{
    ...
    public class IonMember
    {
        ...
        {
            return IonValueObject.ReadObject(ValueJson());
        }

        public bool IsForm(out IonForm? form)
        {
            if (this.Name == "form")
            {
                IonValueObject valueObject = this.ValueObject();
                if (valueObject.HasValidRelArray() || valueObject.HasValueArray())
                {
                    form = AsForm();
                    return true;
                }
        ...
        public IonForm AsForm()
        {
            return IonForm.ReadForm(ValueJson());
        }
        ...
        {
            return IsForm(out _);
            //return new IonFormMemberValidationResult(this).Success;
        }
        ...
        public override bool Equals(object value)
        {
            ...
            if (value is IonMember ionMember && this.Value != null)
            {
