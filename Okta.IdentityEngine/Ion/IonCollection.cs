...
namespace Okta.IdentityEngine.Ion
{
    ...
    public class IonCollection : IonValueObject, IJsonable, IIonJsonable, IEnumerable, IEnumerable<IonValueObject>
    {
        ...
        private List<IonValueObject> ionValueObjectList;
        ...
        public IonCollection()
        {
            ...
            this.ionValueObjectList = new List<IonValueObject>();
        ...
        public IonCollection(List<JToken> jTokens)
        {
            ...
            this.ionValueObjectList = jTokens.Select(jt => new IonValueObject { Value = jt }).ToList();
            this.metaDataElements = new Dictionary<string, object>();
            this.Value = this.ionValueObjectList;
        }
        ...
        public static IonCollection ReadCollection(string json)
        {
