...
namespace Okta.IdentityEngine.Ion
{
    public static class JsonExtensions
    {
        ...
        public static string ToJson(this Dictionary<string, object> value, bool pretty, NullValueHandling nullValueHandling = NullValueHandling.Ignore)
        {
            Formatting formatting = pretty ? Formatting.Indented : Formatting.None;
            JsonSerializerSettings settings = new JsonSerializerSettings
            {
        ...
        public static string ToJson(this Dictionary<string, object> value, JsonSerializerSettings settings)
        {
            return JsonConvert.SerializeObject(value, settings);
        }
